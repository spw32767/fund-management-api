...
type ThaiJOBatchImportRun struct {
	...
	LimitCount       *int       `json:"limit_count,omitempty" gorm:"column:limit_count"`
	...
	JournalsCreated  int        `json:"journals_created" gorm:"column:journals_created;not null;default:0"`
	JournalsUpdated  int        `json:"journals_updated" gorm:"column:journals_updated;not null;default:0"`
	...
	RejectedHits     int        `json:"rejected_hits" gorm:"column:rejected_hits;not null;default:0"`
...
func (ThaiJOBatchImportRun) TableName() string { return "thaijo_batch_import_runs" }
