	...
	v1 := router.Group("/api/v1")
	{
		...
		protected.Use(middleware.AuthMiddleware())
		{
			...
			))
			{
				...
				admin.GET("/paper-ai/classification/runs/:id/items", controllers.ListPaperClassificationItems)
				admin.POST("/paper-ai/classification/runs/:id/stop", controllers.StopPaperClassificationRun)
				admin.POST("/paper-ai/classification/runs/:id/resume", controllers.ResumePaperClassificationRun)
				admin.POST("/paper-ai/classification/runs/:id/retry-failed", controllers.RetryFailedPaperClassificationRun)
				...
				admin.POST("/user-publications/import/thaijo", controllers.AdminImportThaiJOPublications)
				admin.POST("/user-publications/import/thaijo/all", controllers.AdminImportThaiJOForAll)
				...
				admin.GET("/scopus/conference/runs", controllers.AdminListScopusConferenceFetchRuns)
				admin.POST("/scopus/benchmark/affiliation/lookup", controllers.AdminBenchmarkResolveAffiliation)
				admin.GET("/scopus/benchmark/scopes", controllers.AdminListBenchmarkScopes)
				admin.PUT("/scopus/benchmark/scopes/:id", controllers.AdminUpdateBenchmarkScope)
				admin.GET("/scopus/benchmark/scopes/:id/year-range", controllers.AdminDetectBenchmarkYearRange)
				admin.POST("/scopus/benchmark/counts/refresh", controllers.AdminRefreshBenchmarkCounts)
				admin.POST("/scopus/benchmark/harvest", controllers.AdminHarvestBenchmarkScope)
				...
				admin.GET("/scopus/benchmark/documents/export", controllers.AdminExportBenchmarkDocuments)
				...
				admin.GET("/thaijo/import/jobs", controllers.AdminListThaiJOAPIImportJobs)
				admin.GET("/thaijo/import/batch/runs", controllers.AdminListThaiJOBatchImportRuns)
				admin.GET("/thaijo/import/jobs/:id/requests", controllers.AdminListThaiJOAPIRequests)
				...
				admin.GET("/users/thaijo", controllers.AdminListUsersWithThaiJO)
				...
				admin.POST("/users/:id/thaijo-author", controllers.AdminSetUserThaiJOAuthorID)
				admin.POST("/users/:id/thaijo-sync", controllers.AdminSetUserThaiJOSyncEnabled)
